...
We are happy to provide design and analysis support to faculty in the Department of Ophthalmology. **Please note that at this time we are only able to accommodate one request per attending faculty member at a time due to limited resources.**

Most requests for support fall into the following categories.  Please be prepared to share the following information with us before our first meeting!
...
**Strive for good scientific & statistical practices!**
...
Below is a summary of the typical amount of time that different types of requests require. Every project is different, but this is based on our overall experience over many years. We strive to have at least one member of our faculty devote ~1 day per week to this work, so providing design or analysis advice will typically have a quick turn-around (i.e., ~1 week), but a data analysis project can require multiple months to complete, depending on the queue of requests.
...
`*` These times vary, depending on how many data analysis projects are in the queue
...
If you have not received a response within 1 week of submitting the form then please email Dr. Kieran O'Brien (kieran.obrien@ucsf.edu), who is Proctor's faculty member that currently coordinates the design and analysis advisory services to the department. 
